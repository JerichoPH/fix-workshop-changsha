...
Route::group(['middleware' => ['web-check-login', 'web-get-current-menu']], function () {
    ...
    Route::group(['prefix' => ''], function () {
        ...
        Route::group(['prefix' => 'monitor'], function () {
            Route::get('/', 'IndexController@monitor')->name('index.monitor');  // 监控大屏
    ...
    Route::group(['middleware' => 'web-check-permission'], function () {
        ...
        Route::group(['prefix' => 'kindS'], function () {
            ...
            Route::get('/categoryuo/{unique_code}', 'KindSController@getCategory')->name('web.KindS.getCategory');
        ...
        Route::group(['prefix' => 'storehouse', 'namespace' => 'Storehouse'], function () {
            ...
            Route::group(['prefix' => 'index'], function () {
                ...
                // 报损
                Route::group(['prefix' => 'frmLoss'], function () {
                    Route::get('order', 'IndexController@frmLossWithOrder')->name('storehouse.index.frmLoss.order');  // 仓库管理-报损单查询
                    Route::post('confirm', 'IndexController@frmLossWithConfirm')->name('storehouse.index.frmLoss.confirm');  // 仓库管理-报损-确认报损
                    Route::get('instance', 'IndexController@frmLossWithInstance')->name('storehouse.index.frmLoss.instance');  // 仓库管理-报损-设备列表
                });
        ...
        Route::group(['prefix' => 'entire', 'namespace' => 'Entire'], function () {
            ...
            // 整件台账
            Route::get('maintain', 'MaintainController@index')->name('entire-maintain');
            ...
            Route::group(['prefix' => 'instance'], function () {
                ...
                Route::get('/{sn}/uploadEditDeviceReport', 'InstanceController@getUploadEditDeviceReport')->name('web.entire.instance.getgetUploadEditDeviceReport');  // 批量编辑报告页面
            ...
            Route::group(['prefix' => 'tagging'], function () {
                Route::post('/rollback/{id}', 'TaggingController@postRollback')->name('web.tagging.postRollback');  // 设备/器材 回退
                Route::get('/reportShow/{id}', 'TaggingController@getReportShow')->name('web.tagging.getReportShow');  // 设备/器材 详情
                Route::get('/report', 'TaggingController@getReport')->name('web.tagging.getReport');  // 设备/器材赋码 记录
                Route::get('/downloadUploadCreateDeviceExcelTemplate', 'TaggingController@getDownloadUploadCreateDeviceExcelTemplate')->name('web.tagging.getDownloadUploadCreateDeviceExcelTemplate');  // 设备/器材 下载赋码模板excel
                Route::get('/uploadCreateDevice', 'TaggingController@getUploadCreateDevice')->name('web.tagging.getUploadCreateDevice');  // 设备/器材赋码 上传页面
                Route::post('/uploadCreateDevice', 'TaggingController@postUploadCreateDevice')->name('web.tagging.postUploadCreateDevice');  // 设备/器材赋码 上传
                Route::get('/{serial_number}/uploadCreateDeviceReport', 'TaggingController@getUploadCreateDeviceReport')->name('web.tagging.getUploadCreateDeviceReport');  // 设备/器材赋码 上传结果页面
                Route::get('/{serial_number}/downloadCreateDeviceErrorExcel', 'TaggingController@getDownloadCreateDeviceErrorExcel')->name('web.tagging.getDownloadCreateDeviceErrorExcel');  // 设备/器材赋码 下载上传结果报告Excel
            });
        });
        ...
        Route::group(['prefix' => 'search'], function () {
            Route::get('/bindCrossroadNumber/{bind_crossroad_number}', 'SearchController@getBindCrossroadNumber')->name('search.getBindCrossroadNumber');  // 绑定设备页面
        ...
        Route::group(['prefix' => 'report'], function () {
            ...
            Route::get('scrapedWithCategory/{categoryUniqueCode}', 'Report\ScrapedController@scrapedWithCategory')->name('report.scraped.category');  // 超期使用
            Route::get('scrapedWithEntireModel/{entireModelUniqueCode}', 'Report\ScrapedController@scrapedWithEntireModel')->name('report.scraped.entireModel');  // 超期使用
            Route::get('scrapedWithSubModel/{subModelUniqueCode?}', 'Report\ScrapedController@scrapedWithSubModel')->name('report.scraped.subModel');  // 超期使用
            ...
            Route::get('maintainEntireInstances', 'Report\MaintainController@gatMaintainEntireInstances')->name('report-maintain.entireInstances');  // 台账设备列表
        ...
        Route::group(['prefix' => 'testing'], function () {
            Route::get('/', 'TestingController@index')->name('testing.index');  // 测试列表
            Route::get('/create', 'TestingController@create')->name('testing.create');  // 测试新建页面
            Route::post('/', 'TestingController@store')->name('testing.store');  // 测试新建
            Route::get('/{id}', 'TestingController@show')->name('testing.show');  // 测试详情页面
            Route::get('/{id}/edit', 'TestingController@edit')->name('testing.edit');  // 测试编辑页面
            Route::put('/{id}', 'TestingController@update')->name('testing.update');  // 测试编辑
            Route::delete('/{id}', 'TestingController@destroy')->name('testing.destroy');  // 测试删除
        });
