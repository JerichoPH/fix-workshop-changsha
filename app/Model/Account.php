 ...
 * @property-read \App\Model\Organization|null $organization
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account newQuery()
 * @method static \Illuminate\Database\Query\Builder|\App\Model\Account onlyTrashed()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account query()
 * @method static bool|null restore()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereAccessKey($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereAccount($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereAvatar($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereDeletedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereEmail($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereEmailCode($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereEmailCodeExp($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereIdentityCode($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereNickname($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereOpenId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereOrganizationId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account wherePassword($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account wherePhone($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereRank($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereReadScope($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereSecretKey($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereStationName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereStationUniqueCode($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereStatusId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereSupervision($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereTempTaskPosition($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereWechatOfficialOpenId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereWorkArea($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereWorkAreaUniqueCode($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereWorkshopCode($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereWorkshopName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereWorkshopUniqueCode($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Account whereWriteScope($value)
 * @method static \Illuminate\Database\Query\Builder|\App\Model\Account withTrashed()
 * @method static \Illuminate\Database\Query\Builder|\App\Model\Account withoutTrashed()
 * @mixin \Eloquent
 */
