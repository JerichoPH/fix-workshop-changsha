                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <div class="btn-group btn-group-sm pull-right">
                                ...
                                <a href="{{ url('tempTaskSubOrder',$tempTaskSubOrder->id) }}/warehouse?type=FULL_FIX&direction=IN" class="btn btn-flat btn-default"><i class="fa fa-sign-in">&nbsp;</i>添加入所单</a>
                                <a href="{{ url('tempTaskSubOrder',$tempTaskSubOrder->id) }}/warehouse?type=FULL_FIX&direction=OUT" class="btn btn-flat btn-default"><i class="fa fa-sign-out">&nbsp;</i>添加出所单</a>
