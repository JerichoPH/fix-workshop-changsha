...
@section('content')
    ...
    <section class="content-header">
        <h1>
            临时检修任务
            <small>报表 {{ $current_category_name }}</small>
        </h1>
{{--        <ol class="breadcrumb">--}}
{{--            <li><a href="/"><i class="fa fa-dashboard"></i> 主页</a></li>--}}
{{--            <li><a href="{{ url('report/temporatyTask/production/main') }}">临时检修任务 所有种类</a></li>--}}
{{--            <li class="active">临时检修任务 {{ $current_category_name }}</li>--}}
{{--        </ol>--}}
    </section>
