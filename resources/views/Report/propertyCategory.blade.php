    ...
    <script>
        ...
        function fnMakePropertyTable() {
            ...
            $.each(tmp, function (mu, mItem) {
                ...
                $.each(mItem, function (fu, v) {
                    let url = `/report/propertySubModel?category_unique_code=${mu.slice(0, 3)}&entire_model_unique_code=${mu.slice(0, 5)}&sub_model_unique_code=${mu}&factory_unique_code=${fu}`;
