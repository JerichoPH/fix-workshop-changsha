...
{{--                            <div class="input-group-btn"><a href="{{ url('temporaryTask/production/sub',$in_sn) }}?type=HIGH_FREQUENCY&direction=OUT" class="btn btn-flat btn-default"><i class="fa fa-arrow-left">&nbsp;</i>返回</a></div>--}}
