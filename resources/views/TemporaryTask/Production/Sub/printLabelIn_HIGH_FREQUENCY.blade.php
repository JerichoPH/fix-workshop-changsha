                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="input-group pull-right">
                            <div class="input-group-btn"><a href="{{ url('temporaryTask/production/sub',$in_sn) }}?type=NEW_STATION&direction=OUT" class="btn btn-flat btn-default"><i class="fa fa-arrow-left">&nbsp;</i>返回</a></div>
