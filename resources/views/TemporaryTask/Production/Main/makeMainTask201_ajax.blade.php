    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">盯控干部确认任务完成<h4>
            </div>
                ...
                <form id="frmStoreMakeSubTask103">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 col-md-8">
                            <textarea id="txaContent201" name="content" rows="10" cols="80"></textarea>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    $(function () {
        ...
        // 初始化 ckeditor
        CKEDITOR.replace('txaContent201', {
            toolbar: [
    ...
    function fnStoreMakeMainTask104() {
        if (confirm('指定盯控干部不可逆，确认指定？')) $.ajax({
            ...
            data: {
                ...
                message: CKEDITOR.instances['txaContent201'].getData(),
            },
            async: true,
            success: res => {
