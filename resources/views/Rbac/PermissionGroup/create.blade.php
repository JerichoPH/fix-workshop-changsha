...
{{--                    <a href="{{url('rbac/permissionGroup')}}" class="btn btn-default pull-left btn-flat btn-lg">返回</a>--}}
                    <a href="#" onclick="javascript :history.back(-1);" class="btn btn-default pull-left btn-flat btn-lg">返回</a>
                    <a href="javascript:" onclick="fnCreate()" class="btn btn-success pull-right btn-flat btn-lg">新建</a>
                </div>
            </form>
        </div>
    </section>
