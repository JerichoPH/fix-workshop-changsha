            ...
            <div class="col-md-12">
                <div class="box box-solid">
                    ...
                    <form class="form-horizontal" id="frmStore" action="" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="workAreaType" value="{{ session('account.work_area_by_unique_code.type') }}">
                        <input type="hidden" name="workAreaUniqueCode" value="{{ session('account.work_area_by_unique_code.unique_code') }}">
                        ...
                        <div class="box-footer">
                            <a href="/" class="btn btn-default btn-flat btn-sm pull-left"> <i class="fa fa-arrow-left btn-flat">&nbsp;</i> 返回主页 </a>
...
@section('script')
    <script>
        ...
        function fnDownloadExcelTemplate(workAreaUniqueCode) {
            open(`{{ url('entire/instance/downloadUploadEditDeviceExcelTemplate') }}?work_area_unique_code=${workAreaUniqueCode}`, '_blank');
        }
    </script>
@endsection
