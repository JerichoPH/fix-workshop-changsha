...
{{--        <li class="active">批量导入供应商</li>--}}
{{--      </ol>--}}
    </section>
    <section class="content">
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">批量导入整件类型</h3>
                {{--右侧最小化按钮--}}
...
{{--                        <a href="{{url('entire/model')}}" class="btn btn-default btn-flat pull-left"><i class="fa fa-arrow-left">&nbsp;</i>返回</a>--}}
