...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-header">
            <h3 class="box-title">
                整件种类型列表(总计：{{ $categories->count() }}个)
                <span class="text-danger">&emsp;&emsp;说明：设备只需添加种类、类型，器材添加到型号</span>
            </h3>
            <!--右侧最小化按钮-->
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <select name="category_unique_code" id="selCategory" class="form-control select2"
                            ...
                            <option value="{{ $category->unique_code }}"
                                {{ $current_category_unique_code == $category->unique_code ? 'selected' : '' }}>
                                ...
                                <tr
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="javascript:" class="btn btn-primary btn-flat btn-sm"
                                                onclick="modalEditEntireModel('{{ $entire_model->unique_code }}')"><i
                                                    class="fa fa-pencil">&nbsp;</i>编辑</a>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <table class="table table-hover table-striped table-condensed" id="tblSubModel">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="javascript:" class="btn btn-warning btn-flat btn-sm"
                                                    onclick="modalEditSubModel('{{ $sub_model->unique_code }}')"><i
                                                        class="fa fa-pencil">&nbsp;</i>编辑</a>
                                            </div>
                                        </td>
                                    </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <form id="frmStoreCategory">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-8">
                                <input type="radio" name="race" value="S" id="rdoCreateCategoryEquipment" checked><label
                                    for="rdoCreateCategoryEquipment">设备</label>&emsp;&emsp;
                                <input type="radio" name="race" value="Q" id="rdoCreateCategoryDevice"><label
                                    for="rdoCreateCategoryDevice">器材</label>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success btn-flat btn-sm" onclick="fnStoreCategory()"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body form-horizontal">
                    <form id="frmStoreEntireModel">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-8">
                                <input type="number" min="0" step="1" class="form-control" name="cycle_fix_value"
                                    value="0">
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-flat pull-left btn-sm" data-dismiss="modal"><i
                            class="fa fa-times">&nbsp;</i>关闭</button>
                    <button type="button" class="btn btn-success btn-flat btn-sm" onclick="fnStoreEntireModel()"><i
                            class="fa fa-check">&nbsp;</i>保存</button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form-horizontal">
                    <form id="frmUpdateEntireModel">
                        <input type="hidden" name="category_unique_code"
                            id="hdnCategoryUniqueCode_modalEditEntireModel">
                        <input type="hidden" name="unique_code" id="hdnEntireModelUniqueCode_modalEditEntireModel">
                        <div class="form-group">
                            <label class="col-sm-3 col-md-3 control-label">类型名称：</label>
                            <div class="col-sm-9 col-md-8">
                                <input type="text" class="form-control" name="name" value=""
                                    id="txtName_modalEditEntireModel">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 col-md-3 control-label">周期修(年)：</label>
                            <div class="col-sm-9 col-md-8">
                                <input type="number" min="0" step="1" class="form-control" name="fix_cycle_value"
                                    value="0" id="numFixCycleValue_modalEditEntireModel">
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body form-horizontal">
                    <form id="frmStoreSubModel">
                        <div class="form-group">
                            <label class="col-sm-3 col-md-3 control-label">所属种类：</label>
                            <div class="col-sm-9 col-md-8">
                                <select name="category_unique_code" class="form-control select2"
                                    id="selCategory_modalCreateSubModel" style="width: 100%;"
                                    onchange="fnFillEntireModel_modalCreateSubModelByCategoryUniqueCode(this.value)"></select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 col-md-3 control-label">所属类型：</label>
                            <div class="col-sm-9 col-md-8">
                                <select name="entire_model_unique_code" class="form-control select2"
                                    id="selEntireModel_modalCreateSubModel" style="width: 100%;"></select>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-flat pull-left btn-sm" data-dismiss="modal"><i
                            class="fa fa-times">&nbsp;</i>关闭</button>
                    <button type="button" class="btn btn-success btn-flat btn-sm" onclick="fnCreateSubModel()"><i
                            class="fa fa-check">&nbsp;</i>保存</button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form-horizontal">
                    <form id="frmUpdateSubModel">
                        ...
                        <input type="hidden" name="entire_model_unique_code"
                            id="hdnEntireModelUniqueCode_modalEditSubModel">
                        <input type="hidden" name="unique_code" id="hdnSubModelUniqueCode_modalEditSubModel">
                        <div class="form-group">
                            <label class="col-sm-3 col-md-3 control-label">型号名称：</label>
                            <div class="col-sm-9 col-md-8">
                                <input type="text" class="form-control" name="name" value=""
                                    id="txtName_modalEditSubModel">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 col-md-3 control-label">周期修(年)：</label>
                            <div class="col-sm-9 col-md-8">
                                <input type="number" min="0" step="1" class="form-control" name="fix_cycle_value"
                                    value="0" id="numFixCycleFixValue_modalEditSubModel">
                            </div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-flat pull-left btn-sm" data-dismiss="modal"><i
                            class="fa fa-times">&nbsp;</i>关闭</button>
                    <button type="button" class="btn btn-success btn-flat btn-sm" onclick="fnUpdateSubModel()"><i
                            class="fa fa-check">&nbsp;</i>保存</button>
                </div>
            </div>
        </div>
...
<script>
    let $select2 = $('.select2');
        ...
        let deviceCategories = JSON.parse('{!! $device_categories_as_json !!}');
        let deviceEntireModelsByCategoryUniqueCode = JSON.parse('{!! $device_entire_models_by_category_unique_code_as_json !!}');
         ...
         * 填充种类列表
         */
        function fnFillCategory_modalCreateSubModel(categoryUniqueCode) {
            let html = '';
            let currentCategoryUniqueCode = null;
            if (categoryUniqueCode) {
                if (deviceCategories.hasOwnProperty(categoryUniqueCode)) currentCategoryUniqueCode = categoryUniqueCode;
            } else {
                currentCategoryUniqueCode = Object.keys(deviceCategories)[0];
            }
            $.each(deviceCategories, function (cu, cn) {
                html += `<option value="${cu}" ${currentCategoryUniqueCode === cu ? 'selected' : '' }>${cn}</option>`;
            });
            $selCategory_modalCreateSubModel.html(html);
            fnFillEntireModel_modalCreateSubModelByCategoryUniqueCode(currentCategoryUniqueCode);
        }

        /**
         * 根据种类代码刷新类型列表
         */
        function fnFillEntireModel_modalCreateSubModelByCategoryUniqueCode(categoryUniqueCode = '') {
            let html = '';
            let currentCategoryUniqueCode = null;
            if (categoryUniqueCode) {
                if (deviceEntireModelsByCategoryUniqueCode.hasOwnProperty(categoryUniqueCode)) {
                    currentCategoryUniqueCode = categoryUniqueCode;
                }
            } else {
                currentCategoryUniqueCode = Object.keys(deviceEntireModelsByCategoryUniqueCode)[0];
            }
            if (currentCategoryUniqueCode) {
                let entireModels = deviceEntireModelsByCategoryUniqueCode[currentCategoryUniqueCode];
                $.each(entireModels, function (entireModelK, entireModelV) {
                    html += `<option value="${entireModelV.unique_code}">${entireModelV.name}</option>`;
                });
            }
        ...
        $(function () {
            ...
            fnFillCategory_modalCreateSubModel($selCategory.val());
        });
