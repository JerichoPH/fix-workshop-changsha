        ...
        <li style="display: inline-block; width: 200px;">
            <div class="input-group">
                ...
                <input
                    ...
                    onkeydown="if((event.keyCode || event.which) === 13) location.href=`?{!! http_build_query(request()->except('page')) !!}&page=${$('#txtPage').val()}`"
                    onfocus="this.select()"
                >
                <div class="input-group-btn">
                    <button
                        type="button"
                        onclick="location.href=`?{!! http_build_query(request()->except('page')) !!}&page=${$('#txtPage').val()}`"
