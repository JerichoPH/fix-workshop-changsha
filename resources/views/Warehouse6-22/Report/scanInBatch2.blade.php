                ...
                <div class="box-header">
                    <div class="row">
                        <div class="col-md-4">
                            <h3 class="box-title">
                                待{{ $title }}设备列表
                                <small>设备总数：{{ $entire_instances->count() }}</small>
                            </h3>
                        </div>
                        <div class="col-md-8">
                            <!--右侧最小化按钮-->
                                ...
                                <tr>
                                    ...
                                    @if(request('direction') == 'OUT')
                                        <td>
                                            ...
                                            {{ $entire_instance->scrossroad_number }}
                                            {{ $entire_instance->traction }}
                                            {{ $entire_instance->line_name }}
                                            {{ $entire_instance->crossroad_type }}
                                            {{ $entire_instance->point_switch_group_type }}
                                            {{ $entire_instance->open_direction }}
                                            {{ $entire_instance->said_rod }}
                                        </td>
                                    @endif
                                    <td>
