        ...
        <form id="frmScreen">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">设备报废列表 (总数：{{empty($entireInstances) ? 0 : $entireInstances->total()}})</h3>
                    <div class="box-tools pull-right">
                        <a href="JavaScript:" onclick="fnScrap()" class="btn btn-success btn-flat">确认报废</a>
                    </div>
                </div>
        ...
        @section('script')
            ...
            <script>
                ...
                function fnScrap() {
                    let loading = layer.load(2, {shade: false});
                    $.ajax({
                        url: `{{url('storehouse/index/scrap/confirm')}}`,
                        type: 'post',
                        async: true,
                        success: response => {
                            console.log(`success:`, response);
