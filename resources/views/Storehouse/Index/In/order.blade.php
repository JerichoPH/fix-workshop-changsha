                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                            <label style="font-weight: normal;">
                                                <input type="checkbox" id="chkMadeAt" value="1" {{request('use_made_at') == '1' ? 'checked' : ''}}>入库时间
                                            </label>
                                        </div>
...
@section('script')
    <script>
        ...
        function fnScreen() {
            ...
            location.href = `{{url('storehouse/index/in/order')}}?updated_at=${updated_at}&use_made_at=${use_made_at}`
        }
