        ...
        @include('Layout.alert')
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                            <label style="font-weight: normal;">
                                                <input type="checkbox" id="chkMadeAt" value="1" {{request('use_made_at') == '1' ? 'checked' : ''}}>报损时间
                                            </label>
                                        </div>
            ...
            <div class="box box-solid">
                <div class="box-header">
                    ...
                    {{--右侧最小化按钮--}}
                    <div class="box-tools pull-right">
                        <a href="{{url('storehouse/index/frmLoss/instance')}}" class="btn btn-success">报损</a>
                    </div>
                </div>
...
@section('script')
    <script>
        ...
        function fnScreen() {
            ...
            location.href = `{{url('storehouse/index/frmLoss/order')}}?updated_at=${updated_at}&use_made_at=${use_made_at}`
        }
