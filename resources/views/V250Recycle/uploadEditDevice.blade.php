            ...
            <div class="col-md-12">
                <div class="box box-solid">
                    <div class="box-header">
                        <h3 class="box-title">上传设备数据补充</h3>
                        <!--右侧最小化按钮-->
                        <div class="btn-group btn-group-sm pull-right">
                            <a href="{{ url('v250TaskOrder/downloadUploadEditDeviceExcelTemplate') }}?type={{ request('type') }}&workAreaType={{ $taskOrder->WorkAreaByUniqueCode->type }}" class="btn btn-default btn-flat btn-sm pull-right" target="_blank"><i class="fa fa-download">&nbsp;</i>下载模板</a>
                        </div>
                    </div>
