                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="input-group pull-right">
                            <div class="input-group-btn"><a href="{{ url('repairBase/highFrequencyOrder',$in_sn) }}?direction=IN" class="btn btn-flat btn-default"><i class="fa fa-arrow-left">&nbsp;</i>返回</a></div>
