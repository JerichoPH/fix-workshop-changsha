...
{{--            <li><a href="{{ url('/repairBase/newInOrder') }}?page={{ request('page',1) }}"> 新购列表</a></li>--}}
{{--            <li class="active"> 新购检修任务分配</li>--}}
{{--        </ol>--}}
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-solid">
                    <div class="box-header">
                        <div class="row">
                            <div class="col-md-9">
                                <h3 class="box-title">新购 {{ request('date',date('Y-m')) }}</h3>
                            </div>
                            <div class="col-md-3">
                ...
                <div class="box box-solid">
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <a href="{{ url('repairBase/newInOrder/mission') }}?download=1&date={{ request('date',date('Y-m')) }}" target="_blank"><i class="fa fa-save">&nbsp;</i>下载Excel</a>
                        </div>
                    </div>
                    <form id="frmMission">
                        <div class="box-body table-responsive">
...
@section('script')
    <script>
        ...
        function fnSavePlan() {
            ...
            $.ajax({
                url: `/repairBase/newInOrder/mission?date=${$dpCreatedAt.val()}`,
                type: 'post',
                data: $('#frmMission').serialize(),
                async: true,
                success: function (response) {
                    console.log(`/repairBase/newInOrder/mission success:`, response);
                    // alert(response.message);
                    location.reload();
                },
                fail: function (error) {
                    console.log(`/repairBase/newInOrder/mission fail:`, error);
