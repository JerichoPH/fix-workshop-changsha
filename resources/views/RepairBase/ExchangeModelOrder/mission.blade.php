...
{{--            <li><a href="{{ url('/repairBase/exchangeModelOrder') }}?page={{ request('page',1) }}"> 更换设备列表</a></li>--}}
{{--            <li class="active"> 更换设备检修任务分配</li>--}}
{{--        </ol>--}}
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-solid">
                    <div class="box-header">
                        <div class="row">
                            <div class="col-md-9">
                                <h3 class="box-title">更换设备 {{ request('date',date('Y-m')) }}</h3>
                            </div>
                            <div class="col-md-3">
                ...
                <div class="box box-solid">
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <a href="{{ url('repairBase/exchangeModelOrder/mission') }}?download=1&date={{ request('date',date('Y-m')) }}" target="_blank"><i class="fa fa-save">&nbsp;</i>下载Excel</a>
                        </div>
                    </div>
                    <form id="frmMission">
                        <div class="box-body table-responsive">
...
@section('script')
    <script>
        ...
        function fnSavePlan() {
            ...
            $.ajax({
                url: `/repairBase/exchangeModelOrder/mission?date=${$dpCreatedAt.val()}`,
                type: 'post',
                data: $('#frmMission').serialize(),
                async: true,
                success: function (response) {
                    console.log(`/repairBase/exchangeModelOrder/mission success:`, response);
                    // alert(response.message);
                    location.reload();
                },
                fail: function (error) {
                    console.log(`/repairBase/exchangeModelOrder/mission fail:`, error);
