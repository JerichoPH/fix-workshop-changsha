                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body no-padding">
                        <div class="mailbox-controls">
                            ...
                            <a href="{{url('message/create')}}?type=send&page={{request('page',1)}}" class="btn btn-default btn-sm"><i class="fa fa-plus"></i></a>
                            <div class="btn-group">
                            ...
                            <table class="table table-hover table-striped">
                                ...
                                @foreach($messages['data'] as $message)
                                    <tr>
                                        ...
                                        <td class="mailbox-name"><a href="{{url('message',$message['id'])}}?type=send">{{$message['sender_affiliation_name']}}:{{$message['sender_name']}}</a></td>
