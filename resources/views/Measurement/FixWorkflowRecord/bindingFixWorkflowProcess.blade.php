                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-md-8">
                                <select id="selCategoryByBindingFixWorkflowProcess" name="category_unique_code" class="form-control select2" style="width: 100%;"
                                        onchange="location.href = '{{url('measurement/fixWorkflowRecord/bindingFixWorkflowProcess',$fixWorkflowProcessSerialNumber)}}?type={{request('type')}}&page={{request('page',1)}}&categoryUniqueCode='+$('#selCategoryByBindingFixWorkflowProcess').val()+'&partModelUniqueCode='+$('#selPartModelByBindingFixWorkflowProcess').val();">
                            ...
                            <div class="col-sm-8 col-md-8">
                                <select id="selPartModelByBindingFixWorkflowProcess" name="part_model_unique_code" class="form-control select2" style="width: 100%;"
                                    ...
                                    @foreach($partModels as $partModel)
                                        <option value="{{$partModel->unique_code}}" {{request('partModelUniqueCode') == $partModel->unique_code ? 'selected' : ''}}>{{$partModel->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
