    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body form-horizontal">
                <form id="frmStoreMeasuredExplain">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10 col-md-8">
                            <textarea name="measured_value" cols="30" rows="5" class="form-control" required autofocus placeholder="例如：无裂纹、无裂痕">{{$fixWorkflowRecord->measured_value}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">是否合格：</label>
                        <label class="control-label" style="text-align: left; font-weight: normal;"><input name="is_allow" type="radio" checked class="minimal" value="1">合格</label>
                        <label class="control-label" style="text-align: left; font-weight: normal;"><input name="is_allow" type="radio" class="minimal" value="0">不合格</label>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <div class="btn-group btn-group-sm">
                    ...
                    <button type="button" class="btn btn-success btn-flat" onclick="fnStoreMeasuredExplain()"><i class="fa fa-check">&nbsp;</i>保存</button>
                </div>
            </div>
        </div>
    </div>
