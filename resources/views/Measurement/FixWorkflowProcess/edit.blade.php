            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        {{--                                @if(\App\Model\FixWorkflow::flipType(request('fixWorkflowType')) == 'FIX')--}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 col-md-8">
                            <div class="input-group date">
                                ...
                                <input name="processed_at" type="text" class="form-control pull-right" id="datepicker" value="{{$fixWorkflowProcess->processed_at ? : date('Y-m-d')}}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 col-md-8">
                            <textarea placeholder="备注" class="form-control" rows="5" type="text" name="note">{{$fixWorkflowProcess->note}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                            {{--                            <a href="{{url('measurement/fixWorkflowRecord/bindingFixWorkflowProcess',$fixWorkflowProcess->serial_number)}}?type={{request('type')}}&page={{request('page',1)}}" class="btn btn-info btn-lg btn-flat pull-right">绑定数据</a>--}}
                            {{--                            <a href="{{url('measurement/fixWorkflowRecord/boundFixWorkflowProcess',$fixWorkflowProcess->serial_number)}}?type={{request('type')}}&page={{request('page',1)}}" class="btn btn-warning btn-lg btn-flat pull-right">取消绑定</a>--}}
                        </div>
                    </div>
                        ...
                        @foreach($fixWorkflowProcess->FixWorkflowRecords as $fixWorkflowRecord)
                            <tr>
                                ...
                                @else
                                    ...
                                    <td>
                                        <input type="number" οnkeyup="value=value.replace(/[\u4e00-\u9fa5]/ig,'')" name="{{$fixWorkflowRecord->serial_number}}" value="{{$fixWorkflowRecord->measured_value}}" onchange="frmStoreFixWorkflowProcessPart(this.name,this.value,'{{$fixWorkflowRecord->Measurement->identity_code}}')">
                ...
                <div class="box-footer">
                    ...
                    <a href="javascript:" onclick="fnUpdateFixWorkflowProcessProcess()" class="btn btn-warning btn-flat pull-right"><i class="fa fa-check">&nbsp;</i>保存</a>
                </div>
            </div>
        </section>
    </form>
        ...
        fnUpdateFixWorkflowProcessProcess = function () {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    location.href = "{{ url('measurement/fixWorkflow',$fixWorkflowProcess->fix_workflow_serial_number) }}/edit?type={{ request('type') }}";
                },
