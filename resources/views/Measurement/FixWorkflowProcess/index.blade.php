                ...
                <table class="table table-hover table-condensed" id="table" style="font-size: 18px;">
                    ...
                    @foreach($fixWorkflowProcesses as $fixWorkflowProcess)
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-lg">
                                    <a href="{{url('measurement/fixWorkflowProcess',$fixWorkflowProcess->serial_number)}}/edit?fixWorkflowSerialNumber={{$fixWorkflowSerialNumber}}&type={{$type}}&page={{request('page',1)}}" class="btn btn-default btn-flat"><i class="fa fa-pencil"></i> 编辑</a>
