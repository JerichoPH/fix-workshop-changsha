                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-lg">
                                    ...
                                    <a href="{{url('measurement/fixWorkflow/create')}}?page={{request('page',1)}}&type=identity_code&identity_code={{$fixWorkflow->EntireInstance->identity_code}}" class="btn btn-warning btn-flat">验收</a>
