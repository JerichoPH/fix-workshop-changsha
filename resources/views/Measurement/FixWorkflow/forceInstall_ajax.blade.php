...
@endsection
<div class="modal fade" id="modalForceInstall">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">强制出库</h4>
            </div>
            <div class="modal-body form-horizontal">
                <form id="frmStoreInstall" style="font-size: 18px;">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10 col-md-8">
                            <input class="form-control input-lg" type="text" autofocus onkeydown="if(event.keyCode==13){return false;}"
                                   name="serial_number" placeholder="用于从老系统中生成的流水号" value="">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" style="display: none;">
                        ...
                        <div class="col-sm-10 col-md-8">
                            <input class="form-control input-lg" type="text" onkeydown="if(event.keyCode==13){return false;}"
                                   name="location_unique_code" placeholder="仓库位置" value="">
                        </div>
                    </div>
                    <div class="form-group" style="display: none;">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success btn-flat btn-lg" onclick="fnForceInstall()"><i class="fa fa-check">&nbsp;</i>确定</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    fnForceInstall = () => {
        $.ajax({
            url: "{{url('measurement/fixWorkflow/forceInstall',$fixWorkflow->serial_number)}}",
            type: "post",
